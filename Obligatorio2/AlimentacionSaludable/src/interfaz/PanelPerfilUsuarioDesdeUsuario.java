...
public class PanelPerfilUsuarioDesdeUsuario extends javax.swing.JPanel {
    ...
    //Constructor
    public PanelPerfilUsuarioDesdeUsuario(Sistema unSistema, PanelHomeDeUsuario unaVentana, Usuario usuario) {
        initComponents();
        sistema = unSistema;
        ventana = unaVentana;
